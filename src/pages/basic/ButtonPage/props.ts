...
const t = createDocsTranslator({
  ...
  icon: { zh: "前置图标文本；复杂图标请使用插槽", en: "Prefix icon text; use the slot for complex icons" },
  ...
  loading: { zh: "展示加载状态并阻止重复触发", en: "Shows loading and prevents duplicate activation" },
...
const propsRows = () => [
  ...
  { name: "native-type", type: "button | submit | reset", default: "button", desc: t("nativeType") },
  { name: "variant", type: "contained | outlined | text", default: "contained", desc: t("variant") },
  { name: "color", type: "primary | secondary | success | warning | danger | info", default: "primary", desc: t("color") },
  { name: "size", type: "sm | md | lg | small | default | large", default: "md", desc: t("size") },
  { name: "shape", type: "default | round | circle | square", default: "default", desc: t("shape") },
  { name: "text / bg / link / round / circle / plain / dashed", type: "boolean", default: "false", desc: t("styleAlias") },

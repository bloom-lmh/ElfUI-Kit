...
const propsRows = () => [
  ...
  },
  {
    ...
    type: "string",
    default: "''",
    desc: pick("禁用边界外的时间，用于范围联动。", "Disable times outside linked range boundaries."),
  },
  {
    name: "format",
    type: "string",
    default: "HH:mm",
    desc: pick("选项展示格式，不改变受控值。", "Option label format; does not change the controlled value."),
  },
  {
    name: "editable",
    type: "boolean",
  ...
  },
  {
    ...
    default: "filled / md / ''",
    desc: pick("共享字段表面、尺寸与背景配置。", "Shared field surface, size, and background configuration."),
  },
  {
...
const eventsRows = () => [
  {
    ...
    desc: pick("提交受控值并报告语义变化。", "Commit the controlled value and report semantic change."),
  },
  {
    name: "clear",
    type: "() => void",

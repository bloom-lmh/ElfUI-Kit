...
const propsRows = () => [
  ...
  },
  {
    ...
    desc: pick("单独覆盖日期或时间区域的展示格式。", "Override date or time display format independently."),
  },
  {
    name: "defaultTime",
  ...
  },
  {
    ...
    type: "string",
    default: "''",
    desc: pick("日期时间整体边界；同一天时会继续约束时间。", "Combined boundaries that also constrain time on matching dates."),
  },
  {
    name: "disabledDate",
  ...
  },
  {
    ...
    default: "[]",
    desc: pick("日期时间快捷项；范围项可同时提供 endValue。", "Date-time shortcuts; range entries may include endValue."),
  },
  {
    name: "label / dateLabel / timeLabel",
    type: "string",
    default: "''",
    desc: pick("组合字段及两个子字段的浮动标签。", "Floating labels for the compound and child fields."),
  },
  {
  ...
  },
  {
    ...
    desc: pick("复用全局清空值与判空策略。", "Reuse global clear-value and empty-value strategies."),
  },
  {
    name: "id / name / tabindex / ariaLabel",
    type: "string | number",
    default: "-",
    desc: pick("原生表单、键盘与无障碍属性。", "Native form, keyboard, and accessibility attributes."),
  },
  {
    name: "validateEvent",
    type: "boolean",
    default: "true",
    desc: pick("是否由组合字段触发 FormItem 校验。", "Whether the compound field triggers FormItem validation."),
  },
];
...
const eventsRows = () => [
  {
    ...
    desc: pick("提交受控值并报告一次语义变化。", "Commit the controlled value and report one semantic change."),
  },
  {
    name: "clear",
    type: "() => void",

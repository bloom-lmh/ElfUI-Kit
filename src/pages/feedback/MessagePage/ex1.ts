...
const t = createDocsTranslator({
  ...
  dangerMessage: { zh: "操作失败，请稍后重试", en: "The operation failed. Please try again later." },
});

const showInfo = (): void => { ElfMessage.info(t("infoMessage")); };
const showSuccess = (): void => { ElfMessage.success(t("successMessage")); };
const showWarning = (): void => { ElfMessage.warning(t("warningMessage")); };
const showDanger = (): void => { ElfMessage.danger(t("dangerMessage")); };

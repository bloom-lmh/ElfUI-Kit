...
const t = createDocsTranslator({
  ...
  topLeftMessage: { zh: "这是一条在左上角弹出的消息通知。", en: "This notification opens in the top-left corner." },
  bottomRightTitle: { zh: "右下角通知", en: "Bottom-right notification" },
  bottomRightMessage: { zh: "这是一条在右下角弹出的消息通知。", en: "This notification opens in the bottom-right corner." },
  bottomLeftTitle: { zh: "左下角通知", en: "Bottom-left notification" },
  bottomLeftMessage: { zh: "这是一条在左下角弹出的消息通知。", en: "This notification opens in the bottom-left corner." },

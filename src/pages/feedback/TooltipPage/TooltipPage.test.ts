...
describe("TooltipPage", () => {
  ...
  it("键盘案例建立可访问描述，并允许 Escape 关闭提示", async () => {
    ...
    trigger!.focus();
    tooltipHost!.shadowRoot!.querySelector<HTMLElement>(".tooltip-container")!.dispatchEvent(
    ...
    expect(tooltipHost!.shadowRoot!.querySelector(".tooltip-content")?.className).toContain("closing");
  });

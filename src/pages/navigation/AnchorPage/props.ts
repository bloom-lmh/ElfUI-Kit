...
const propsRows = [
  ...
  { name: "duration", type: "number", default: "goTo / 300", desc: "smooth scroll duration" },
  { name: "easing", type: "GoToEasing", default: "goTo / easeInOutCubic", desc: "smooth scroll easing strategy" },

...
const t = createDocsTranslator({
  ...
  registerQ: { zh: "页面显示未知的 elf-* 标签，组件没有渲染？", en: "The page shows an unknown elf-* tag and the component does not render?" },
  registerA: {
  ...
  compilerQ: { zh: "defineHtml 能运行，但模板语法没有响应式更新？", en: "defineHtml runs, but template bindings do not update reactively?" },
  compilerA: {
  ...
  duplicateQ: { zh: "控制台提示自定义元素名称冲突？", en: "The console reports a custom-element name conflict?" },
  duplicateA: {
  ...
  overlayQ: { zh: "弹层挂到 body 后会丢失语言、主题或配置吗？", en: "Do body-level overlays lose locale, theme, or configuration?" },
  overlayA: {
  ...
  focusQ: { zh: "关闭 Dropdown/Dialog 时出现 aria-hidden 焦点警告？", en: "Closing a Dropdown or Dialog produces an aria-hidden focus warning?" },
  focusA: {
  ...
  ssrQ: { zh: "SSR 中如何读取视口或访问 DOM？", en: "How should viewport or DOM access work during SSR?" },
  ssrA: {
  ...
  styleQ: { zh: "为什么颜色、圆角或密度与预期不同？", en: "Why do colors, radii, or density differ from the expected design?" },
  styleA: {
  ...
  globalCssQ: { zh: "全局 CSS 为什么选不中组件内部节点？", en: "Why can global CSS not select component internals?" },
  globalCssA: {
  ...
  issueQ: { zh: "什么信息能让 Bug 更快被定位？", en: "What information helps a bug get diagnosed faster?" },
  issueA: {
...
const PageFaq = defineHtml(`
  <elf-container class="docs-article">
    ...
    <section class="docs-section">
      ...
      <details><summary>${t("compilerQ")}</summary><p>${t("compilerA")}</p></details>
      <details><summary>${t("duplicateQ")}</summary><p>${t("duplicateA")}</p></details>
    </section>

    <section class="docs-section">
      <h2>${t("runtime")}</h2>
      <details open><summary>${t("overlayQ")}</summary><p>${t("overlayA")}</p></details>
      <details><summary>${t("focusQ")}</summary><p>${t("focusA")}</p></details>
      <details><summary>${t("ssrQ")}</summary><p>${t("ssrA")}</p></details>
    </section>

    <section class="docs-section">
      <h2>${t("styling")}</h2>
      <details open><summary>${t("styleQ")}</summary><p>${t("styleA")}</p></details>
      <details><summary>${t("globalCssQ")}</summary><p>${t("globalCssA")}</p></details>
    </section>

    <section class="docs-section">
      <h2>${t("release")}</h2>
      <details open><summary>${t("versionQ")}</summary><p>${t("versionA")}</p></details>
      <details><summary>${t("issueQ")}</summary><p>${t("issueA")}</p></details>
    </section>

...
const t = createDocsTranslator({
  ...
  type: { zh: "卡片布局，仅支持直接 CarouselItem 子项", en: "Card layout; requires direct CarouselItem children" },
  ...
  pauseOnFocus: { zh: "轮播或控件获得焦点时暂停", en: "Pauses while the carousel or its controls have focus" },
  reducedMotion: { zh: "系统要求减少动画时阻止自动播放", en: "Blocks autoplay when the system requests reduced motion" },
  ...
  change: { zh: "真实切换后触发，提供当前和上一下标", en: "Emitted after a real change with current and previous indexes" },
...
const propsRows = () => [
  ...
  { name: "show-arrow", type: "circle | square | ghost | false", default: "circle", desc: t("showArrow") },
  ...
  { name: "indicator-position", type: "'' | outside | none", default: "''", desc: t("indicatorPosition") },

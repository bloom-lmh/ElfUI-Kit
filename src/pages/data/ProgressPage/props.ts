...
const t = createDocsTranslator({
  ...
  label: { zh: "进度标签", en: "Progress label" }, labelPosition: { zh: "标签位置", en: "Label position" }, showText: { zh: "显示文字", en: "Show progress text" }, hideValue: { zh: "隐藏数值但保留标签", en: "Hide the value while keeping the label" }, inside: { zh: "条形文字内置", en: "Place text inside the linear bar" }, reverse: { zh: "反转线性布局", en: "Reverse the linear layout" },
  ...
  defaultSlot: { zh: "环形中心内容", en: "Circular center content" }, labelSlot: { zh: "自定义标签", en: "Custom label" }, valueSlot: { zh: "自定义格式化数值", en: "Custom formatted value" }
});
const rows = () => [
  ...
  { name: "label / label-position", type: "string / top | bottom | start | end", default: "'' / top", desc: `${t("label")} / ${t("labelPosition")}` }, { name: "hide-value", type: "boolean", default: "false", desc: t("hideValue") },
  { name: "text-inside / reverse", type: "boolean", default: "false", desc: `${t("inside")} / ${t("reverse")}` }, { name: "striped", type: "boolean", default: "false", desc: t("striped") },
  ...
  { name: "format / value-format", type: "function / string template", default: "-", desc: t("format") }
];
const slotRows = () => [
...
const PageProgressProps = defineHtml(`<h2>API</h2><elf-props-table title="Props" :rows.prop=${rows()}></elf-props-table><elf-props-table title="Slots" :rows.prop=${slotRows()}></elf-props-table>`);

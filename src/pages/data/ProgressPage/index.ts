...
const t = createDocsTranslator({
  ...
  description: { zh: "清晰表达任务完成度，支持线性、环形、仪表盘、标签、格式化、插槽与不确定状态。", en: "Communicate completion clearly with linear, circular, dashboard, label, formatting, slot, and indeterminate states." }
});

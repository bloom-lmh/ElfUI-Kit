...
const propsRows = [
  { name: "icon", type: "success | warning | error | info", default: "info", desc: pick("结果状态及默认图形", "Result state and default graphic") },
  { name: "title", type: "string", default: "''", desc: pick("结果标题", "Result title") },
  { name: "sub-title", type: "string", default: "''", desc: pick("补充说明", "Supporting description") }
];
...
const slotsRows = [
  ...
  { name: "extra", desc: pick("结果后的操作按钮或链接", "Actions or links shown after the result") }
];

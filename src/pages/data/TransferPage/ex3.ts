...
const t = createDocsTranslator({
  title: { zh: "长标签、面板底部与窄容器", en: "Long labels, panel footers, and narrow containers" },
  playground: { zh: "窄容器自动切换为纵向布局", en: "Narrow containers switch to a vertical layout automatically." },
  design: { zh: "设计系统与跨产品主题规范维护负责人", en: "Design system and cross-product theme standards owner" },
  frontend: { zh: "前端组件库构建、测试与发布流水线维护者", en: "Frontend library build, test, and release pipeline maintainer" },
  quality: { zh: "质量保障与无障碍体验专项负责人", en: "Quality assurance and accessibility owner" },
  docs: { zh: "文档站案例与 API 一致性维护者", en: "Documentation examples and API consistency maintainer" },

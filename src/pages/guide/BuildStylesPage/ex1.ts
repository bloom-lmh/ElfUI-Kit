...
const t = createDocsTranslator({
  ...
  componentEntry: { zh: "组件、Provider 与公共类型", en: "Components, Providers, and public types" },
  utilityEntry: { zh: "可选工具类样式", en: "Optional utility-class styles" },
  stable: { zh: "稳定", en: "Stable" },
  optional: { zh: "按需", en: "Optional" },
  appEntry: { zh: "应用入口：注册组件与 Provider", en: "Application entry: register components and Providers" },
  optionalEntry: { zh: "可选入口：只在使用工具类时引入", en: "Optional entry: import only when using utility classes" },
  scriptComment: {

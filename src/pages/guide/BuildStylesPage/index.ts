...
const buildRows = [
  {
    ...
    default: "required",
    desc: pick("组件、Provider 和公开类型的稳定入口", "Stable entry for components, Providers, and public types.")
  },
  {
    name: "@elfui/kit/styles/utilities.css",
    type: "CSS",
    default: "optional",
    desc: pick("工具类样式入口；未使用时无需引入", "Optional utility-class stylesheet; omit it when utilities are unused.")
  },
  {
    name: "CSS reset",

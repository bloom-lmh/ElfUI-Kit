...
const t = createDocsTranslator({
  ...
  demo: { zh: "团队活动", en: "Team activity" }, selected: { zh: "当前单元格", en: "Active cell" }, none: { zh: "尚未选择", en: "No cell selected" }, api: { zh: "API", en: "API" }, props: { zh: "属性", en: "Props" }, events: { zh: "事件", en: "Events" }, less: { zh: "较少", en: "Less" }, more: { zh: "较多", en: "More" }, legendFilter: { zh: "按颜色筛选热力图", en: "Filter heatmap by color" }, items: { zh: "二维数据项，按 row / column 定位。", en: "Matrix items addressed by row and column." }, thresholds: { zh: "按 max 升序的颜色阈值。", en: "Color thresholds ordered by max." }, cellSize: { zh: "单元格边长（px）。", en: "Cell edge size in px." }, legend: { zh: "显示色阶图例。", en: "Shows the color-scale legend." }, legendInteractive: { zh: "允许点击图例仅查看对应色阶，再次点击取消筛选。", en: "Lets users click a legend swatch to isolate its color range and click again to clear." }, click: { zh: "单元格点击时返回行、列和数据项。", en: "Returns the row, column, and item when a cell is clicked." }, legendChange: { zh: "图例筛选变化时返回阈值或 null。", en: "Returns the selected threshold or null when the legend filter changes." }
});
...
const eventRows = () => [
  ...
  { name: "legend-change", type: "CustomEvent<HeatmapThreshold | null>", default: "—", desc: t("legendChange") }
];

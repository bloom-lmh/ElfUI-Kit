...
const t = createDocsTranslator({
  ...
  demo: { zh: "自定义控制栏", en: "Custom controls" }, playing: { zh: "播放状态", en: "Playback" }, paused: { zh: "已暂停", en: "Paused" }, active: { zh: "播放中", en: "Playing" }, api: { zh: "API", en: "API" }, props: { zh: "属性", en: "Props" }, src: { zh: "视频资源地址。", en: "Video source URL." }, controls: { zh: "显示可访问的自定义控制栏。", en: "Shows accessible custom controls." }, native: { zh: "改用浏览器原生 controls。", en: "Uses browser-native controls instead." }, rates: { zh: "可选播放速率列表。", en: "Available playback-rate list." }, events: { zh: "事件", en: "Events" }, lifecycleEvent: { zh: "播放生命周期状态变化。", en: "Playback lifecycle state changes." }, timeEvent: { zh: "时间、总时长与归一化进度。", en: "Current time, duration, and normalized progress." }
});
...
const propRows = () => [
  ...
  { name: "playback-rates", type: "number[]", default: "[0.75, 1, 1.25, 1.5, 2]", desc: t("rates") }
];
const eventRows = () => [
  { name: "play / pause / ended", type: "CustomEvent<void>", default: "—", desc: t("lifecycleEvent") },

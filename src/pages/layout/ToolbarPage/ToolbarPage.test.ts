...
describe("ToolbarPage", () => {
  it("renders the Chinese Vuetify-inspired examples", async () => {
    ...
    expect(collapsePlayground.querySelectorAll('[slot="controls"] elf-button')).toHaveLength(3);
    const locationPlayground = page.shadowRoot!.querySelectorAll("elf-playground")[3]!;
    expect(locationPlayground.querySelectorAll('[slot="controls"] elf-button')).toHaveLength(4);

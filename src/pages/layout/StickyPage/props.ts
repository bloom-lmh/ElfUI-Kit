...
const t = createDocsTranslator({
  ...
  teleported: { zh: "将吸附内容投放到 append-to 指定的目标", en: "Teleport sticky content to the append-to target." },
  appendTo: { zh: "内容投放目标", en: "Teleport destination." },
  top: { zh: "顶部吸附偏移", en: "Legacy top offset." },
  bottom: { zh: "底部吸附偏移；设置后启用底部模式", en: "Legacy bottom offset; enables bottom mode when set." },

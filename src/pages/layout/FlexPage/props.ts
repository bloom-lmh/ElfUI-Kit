...
const t = createDocsTranslator({
  ...
  alignContent: { zh: "多行项目在交叉轴上的分布方式", en: "Distribution of wrapped lines on the cross axis" },
  wrap: { zh: "换行策略；boolean 保持原有兼容行为", en: "Wrapping strategy; boolean preserves the legacy behavior" },
...
const spacerRows = () => [{ name: "props / events / slots", type: "—", default: "—", desc: "flex-grow: 1" }];

...
const t = createDocsTranslator({
  sizes: { zh: "尺寸", en: "Sizes" }, states: { zh: "状态", en: "States" }, clearable: { zh: "可清空", en: "Clearable" },
  readonly: { zh: "只读内容", en: "Read-only content" }, disabled: { zh: "禁用", en: "Disabled" },
  clearHint: { zh: "输入后出现清空按钮", en: "Type to show the clear button" }, current: { zh: "当前", en: "Current" }, empty: { zh: "空", en: "Empty" }
});

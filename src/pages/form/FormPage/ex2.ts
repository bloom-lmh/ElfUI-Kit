...
const t = createDocsTranslator({
  title: { zh: "行内筛选", en: "Inline filtering" }, waiting: { zh: "等待筛选", en: "Waiting for filters" },
  all: { zh: "全部", en: "All" }, allStatus: { zh: "全部状态", en: "All statuses" }, running: { zh: "运行中", en: "Running" }, maintenance: { zh: "维护中", en: "Maintenance" }, warning: { zh: "告警", en: "Warning" },
  filter: { zh: "筛选", en: "Filters" }, mine: { zh: "只看我", en: "Only mine" }, owners: { zh: "全部负责人", en: "All owners" },
  card: { zh: "服务筛选", en: "Service filters" }, subtitle: { zh: "紧凑条件适合放在卡片内容区", en: "Compact conditions fit naturally in a card content area." },
  keyword: { zh: "关键词", en: "Keyword" }, keywordHint: { zh: "服务名或负责人", en: "Service or owner" }, status: { zh: "状态", en: "Status" }
});
...
const statusOptions = [
  { label: t("allStatus"), value: "" }, { label: t("running"), value: "running" },
  { label: t("maintenance"), value: "maintenance" }, { label: t("warning"), value: "warning" }
];

...
const t = createDocsTranslator({
  title: { zh: "提交校验", en: "Submit validation" }, playground: { zh: "异步校验、滚动首错与命令方法", en: "Async validation, scroll-to-error, and command methods" },
  waiting: { zh: "等待提交", en: "Waiting to submit" }, project: { zh: "项目名称", en: "Project name" }, projectRequired: { zh: "请输入项目名称", en: "Enter a project name" }, occupied: { zh: "该项目名称已被占用", en: "This project name is already in use" },
  owner: { zh: "负责人", en: "Owner" }, ownerRequired: { zh: "请选择负责人", en: "Select an owner" }, desc: { zh: "说明", en: "Description" }, descMin: { zh: "至少 6 个字符", en: "At least 6 characters" },
  validating: { zh: "正在校验项目名称…", en: "Validating the project name…" }, submitted: { zh: "已提交", en: "Submitted" }, invalid: { zh: "校验未通过", en: "Validation failed" },
  checking: { zh: "正在检查项目名称…", en: "Checking the project name…" }, available: { zh: "项目名称可以使用", en: "Project name is available" }, change: { zh: "请修改项目名称", en: "Change the project name" },
  resetDone: { zh: "已重置", en: "Reset complete" }, cleared: { zh: "已清除校验状态", en: "Validation state cleared" }, located: { zh: "已定位到项目名称", en: "Project name located" }, baseline: { zh: "已保存重置基线", en: "Reset baseline saved" }, fields: { zh: "个字段", en: "fields" },
  card: { zh: "新建项目", en: "Create project" }, subtitle: { zh: "校验结果与操作按钮保持在同一张卡片中", en: "Keep validation results and actions in the same card." },
  selectOwner: { zh: "请选择负责人", en: "Select an owner" }, submit: { zh: "提交", en: "Submit" }, validateOnly: { zh: "只校验项目名", en: "Validate project only" }, reset: { zh: "重置", en: "Reset" }, clear: { zh: "清除校验", en: "Clear validation" }, locate: { zh: "定位项目名", en: "Locate project" }, setBaseline: { zh: "设为重置基线", en: "Set reset baseline" },
  lin: { zh: "林舟", en: "Lin Zhou" }, zhou: { zh: "周然", en: "Zhou Ran" }, xu: { zh: "许宁", en: "Xu Ning" }
});
...
const owners = [
  { label: t("lin"), value: "lin" }, { label: t("zhou"), value: "zhou" }, { label: t("xu"), value: "xu" }
];

...
const t = createDocsTranslator({
  title: { zh: "动态字段", en: "Dynamic fields" }, playground: { zh: "动态增删与字段级规则", en: "Dynamic additions, removals, and field-level rules" },
  required: { zh: "请输入域名", en: "Enter a domain" }, invalid: { zh: "域名格式不正确", en: "Invalid domain format" },
  count: { zh: "共", en: "Total" }, domains: { zh: "个域名", en: "domains" }, card: { zh: "允许访问的域名", en: "Allowed domains" },
  subtitle: { zh: "字段路径和校验规则会随列表索引同步", en: "Field paths and validation rules stay synchronized with list indexes." },
  domain: { zh: "域名", en: "Domain" }, remove: { zh: "移除", en: "Remove" }, add: { zh: "添加域名", en: "Add domain" }
});

...
const t = createDocsTranslator({
  title: { zh: "登录表单", en: "Login form" }, playground: { zh: "紧凑登录与即时校验", en: "Compact login with immediate validation" },
  waiting: { zh: "等待登录", en: "Waiting to sign in" }, email: { zh: "邮箱", en: "Email" }, password: { zh: "密码", en: "Password" },
  emailRequired: { zh: "请输入邮箱", en: "Enter an email" }, emailInvalid: { zh: "邮箱格式不正确", en: "Invalid email format" },
  passwordRequired: { zh: "请输入密码", en: "Enter a password" }, passwordMin: { zh: "密码至少 6 位", en: "Password must be at least 6 characters" },
  welcome: { zh: "欢迎回来", en: "Welcome back" }, invalid: { zh: "请检查登录信息", en: "Check your login details" },
  subtitle: { zh: "使用你的 ElfUI 账号继续", en: "Continue with your ElfUI account" }, remember: { zh: "保持登录", en: "Keep me signed in" }, login: { zh: "登录", en: "Sign in" }, hint: { zh: "至少 6 位", en: "At least 6 characters" }
});

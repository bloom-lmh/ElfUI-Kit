...
const rows = [
  ...
  { name: "variant / label", type: "FieldVariant / string", default: "filled / ''", desc: p("字段表面与浮动标签", "Field surface and floating label.") },
  { name: "background-color", type: "string", default: "''", desc: p("自定义字段表面背景", "Custom field surface background.") },
...
const PageMentionProps = defineHtml(`
  ...
  <elf-props-table title="Slots" :rows=${[
    { name: "default", desc: p("自定义建议项内容，接收 item", "Custom suggestion content; receives item.") },

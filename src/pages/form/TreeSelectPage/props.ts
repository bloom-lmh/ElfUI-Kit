...
const propsRows = () => [
  ...
  },
  {
    ...
    desc: pick(
      "启用复选树和数组值。",
      "Enable checkbox-tree selection and array values.",
    ),
  },
  {
    name: "checkStrictly",
  ...
  },
  {
    ...
    desc: pick(
      "配置节点内容点击行为。",
      "Configure node-content click behavior.",
    ),
  },
  {
    ...
    desc: pick(
      "启用搜索并替换节点匹配策略。",
      "Enable search with a custom node matcher.",
    ),
  },
  {
    name: "lazy / load",
    ...
    desc: pick(
      "按展开动作异步加载子节点。",
      "Load child nodes asynchronously on expansion.",
    ),
  },
  {
    ...
    desc: pick(
      "复用 Tree 虚拟窗口处理大数据。",
      "Reuse Tree's virtual window for large data.",
    ),
  },
  {
    name: "renderContent",
  ...
  },
  {
    ...
    desc: pick(
      "多选标签折叠和数量限制。",
      "Multiple-tag collapsing and selection limit.",
    ),
  },
  {
...
const eventsRows = () => [
  ...
  },
  {
    ...
    desc: pick(
      "清空或移除一个多选标签。",
      "Clear the field or remove one multiple tag.",
    ),
  },
  {
    name: "visible-change",
...
const methodsRows = () => [
  ...
  },
  {
    ...
    desc: pick(
      "调用内部 Tree 的过滤协议。",
      "Invoke the inner Tree filter protocol.",
    ),
  },
  {
    name: "selectedLabel()",
  ...
  },
  {
    ...
    desc: pick(
      "读取当前节点或滚动到节点。",
      "Read the current node or scroll to a node.",
    ),
  },
];

...
describe("elf-list", () => {
  ...
  it("moves focus with arrow and boundary keys while skipping disabled items", async () => {
    ...
    first.shadowRoot!.querySelector("button")!.dispatchEvent(new KeyboardEvent("keydown", {
      key: "ArrowDown",
      bubbles: true,
      composed: true
    }));
    ...
    last.shadowRoot!.querySelector("button")!.dispatchEvent(new KeyboardEvent("keydown", {
      key: "Home",
      bubbles: true,
      composed: true
    }));

...
export const createLocaleContext = (
  source: LocaleContextSource,
  ...
  return {
    ...
    t(path, params) {
      ...
      const translated = source.adapter()?.translate(
        path,
        normalizedParams,
        readAdapterContext(),
      );
    ...
    formatNumber(value, options) {
      const formatted = source.adapter()?.formatNumber?.(
        value,
        options,
        readAdapterContext(),
      );
    ...
    formatDate(value, options) {
      const formatted = source.adapter()?.formatDate?.(
        value,
        options,
        readAdapterContext(),
      );

...
export type TableSortBy =
  string | string[] | ((row: TableRow, index: number, rows: TableRow[]) => unknown);
...
export type TableFilterMethod = (value: unknown, row: TableRow, column: TableColumn) => boolean;
...
export type TableRenderValue =
  string | number | boolean | Node | readonly Node[] | null | undefined;
...
export type TableHeaderRowClassName = string | ((context: TableHeaderRowContext) => string);
export type TableHeaderRowStyle = TableStyle | ((context: TableHeaderRowContext) => TableStyle);
export type TableHeaderCellClassName = string | ((context: TableHeaderCellContext) => string);
export type TableHeaderCellStyle = TableStyle | ((context: TableHeaderCellContext) => TableStyle);
...
export interface TableColumn {
  ...
  cellStyle?: TableStyle | ((row: TableRow, column: TableColumn, index: number) => TableStyle);

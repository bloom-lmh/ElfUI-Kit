...
import { defineHtml, defineProps, defineStyle, useHostAttr, useHostCssVar } from "@elfui/core";
...
const mergeResponsive = (
  previous: GridItemState,
  value?: GridItemResponsiveValue,
): GridItemState => {

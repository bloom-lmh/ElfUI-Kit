...
describe("elf-loading", () => {
  it("uses Core Transition as the structural resource owner", () => {
    const source = readFileSync("packages/kit/src/components/Feedback/Loading/index.ts", "utf8");
    const service = readFileSync("packages/kit/src/components/Feedback/Loading/service.ts", "utf8");
    const cssText = readFileSync("packages/kit/src/components/Feedback/Loading/style.scss", "utf8");

...
describe("ElfMessage()", () => {
  ...
  it("uses theme surface and text variables", async () => {
    ...
    const cssText = readFileSync("packages/kit/src/components/Feedback/Message/style.scss", "utf8");
  ...
  it("delegates structural motion to Core Transition with reduced-motion coverage", () => {
    const componentSource = readFileSync(
      "packages/kit/src/components/Feedback/Message/component.ts",
      "utf8",
    );
    const serviceSource = readFileSync(
      "packages/kit/src/components/Feedback/Message/index.ts",
      "utf8",
    );
    const styleSource = readFileSync(
      "packages/kit/src/components/Feedback/Message/style.scss",
      "utf8",
    );

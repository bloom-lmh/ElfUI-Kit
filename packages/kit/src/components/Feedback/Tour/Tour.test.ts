...
describe("elf-tour", () => {
  it("delegates structural motion and modal ownership to shared Core capabilities", () => {
    const source = readFileSync("packages/kit/src/components/Feedback/Tour/index.ts", "utf8");
    const cssText = readFileSync("packages/kit/src/components/Feedback/Tour/style.scss", "utf8");

 ...
 */
export const createControllerDirective = <Value, ElementType extends HTMLElement = HTMLElement>(
  ...
  const mount = (element: ElementType, binding: DirectiveBinding<Value>): void => {

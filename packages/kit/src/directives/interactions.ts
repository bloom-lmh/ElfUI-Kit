...
const normalizeRipple = (value: RippleDirectiveValue): Required<RippleOptions> => {
...
const normalizeTooltip = (value: TooltipDirectiveValue): Required<TooltipDirectiveOptions> => {
...
export const createTooltipController = (
  ...
  const open = (): void => {
    ...
    showTimer = setTimeout(() => {
      ...
      element.setAttribute("aria-describedby", [previousDescribedBy, id].filter(Boolean).join(" "));
      position();
    }, options.showDelay);
  };
...
export const registerRippleDirective = (app: Pick<ElfUIApp, "directive">): void =>
  registerDirective(app, "ripple", rippleDirective as DirectiveDefinition);

export const registerScrollDirective = (app: Pick<ElfUIApp, "directive">): void =>
  registerDirective(app, "scroll", scrollDirective as DirectiveDefinition);

export const registerTooltipDirective = (app: Pick<ElfUIApp, "directive">): void =>
  registerDirective(app, "tooltip", tooltipDirective as DirectiveDefinition);

export const registerTouchDirective = (app: Pick<ElfUIApp, "directive">): void =>
  registerDirective(app, "touch", touchDirective as DirectiveDefinition);

...
const t = createDocsTranslator({
  ...
  vertical: {
    zh: "使用上下排列的垂直分割",
    en: "Use a vertical split with panels arranged top to bottom.",
  },
  ...
  storage: {
    zh: "用于持久化首个面板尺寸的本地存储键",
    en: "Local storage key used to persist the first panel size.",
  },
  panelSize: {
    zh: "未显式绑定 modelValue 时的初始百分比",
    en: "Initial percentage when modelValue is not bound explicitly.",
  },
  panelRange: { zh: "面板尺寸边界", en: "Panel size boundaries." },
  panelCollapse: {
    zh: "显示折叠控制并支持 Home 和 End 键",
    en: "Show collapse controls and support the Home and End keys.",
  },
  panelResize: { zh: "是否允许调整当前面板", en: "Whether the current panel can be resized." },
  lazy: {
    zh: "首次展开前不渲染默认插槽",
    en: "Do not render the default slot before the first expansion.",
  },
  ...
  lifecycle: {
    zh: "指针调整开始和结束时触发",
    en: "Emitted when pointer resizing starts and ends.",
  },

...
const t = createDocsTranslator({
  ...
  comment1: {
    zh: "resizable=false 会同时禁用指针和键盘调整。",
    en: "resizable=false disables both pointer and keyboard resizing.",
  },
  comment2: {
    zh: '分隔条会暴露 aria-disabled="true"。',
    en: 'The separator exposes aria-disabled="true".',
  },
});
...
const PageSplitterEx5 = defineHtml(`
  ...
  <elf-playground :title=${t("title")} :code=${code} :script=${script}>
    ...
    <div class="splitter-demo-stage"><elf-splitter>
      <elf-splitter-panel slot="first" :size=${40} :resizable.prop=${false}>

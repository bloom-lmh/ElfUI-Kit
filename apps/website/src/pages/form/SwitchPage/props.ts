...
const rows = [
  {
    name: "model-value / active-value / inactive-value",
    type: "string | number | boolean",
    default: "false / true / false",
    desc: pick("当前值与开关值", "Current, active, and inactive values."),
  },
  {
    name: "size / width / inline-prompt",
    type: "sm | md | lg / string | number / boolean",
    default: "md / auto / false",
  ...
  {
    name: "active-text / inactive-text / active-icon / inactive-icon",
    type: "string",
    default: "''",
    desc: pick("状态文字与图标", "State text and icons."),
  },
  {
    name: "active-action-icon / inactive-action-icon",
    type: "string",
    default: "''",
    desc: pick("滑块动作图标", "Thumb action icons."),
  },
  {
    name: "disabled / loading / validate-event",
    type: "boolean",
    default: "false / false / true",
    desc: pick("禁用、加载与校验状态", "Disabled, loading, and validation states."),
  },
  {
    name: "id / tabindex / aria-label",
    type: "string / number / string",
    default: "'' / 0 / ''",
    desc: pick("原生与无障碍属性", "Native and accessibility attributes."),
  },
  {
    name: "active-color / inactive-color / border-color",
    type: "string",
    default: "''",
...
const PageSwitchProps = defineHtml(`
  ...
  <elf-props-table title="Slots" :rows=${[
    ...
    {
      name: "active-action / inactive-action",

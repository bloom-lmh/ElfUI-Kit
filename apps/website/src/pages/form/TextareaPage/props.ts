...
const propsRows = [
  ...
  },
  {
    ...
    default: "filled",
    desc: pick("统一字段表面样式", "Shared field-surface variant."),
  },
  { name: "modelValue", type: "string", desc: pick("文本模型值", "Text model value.") },
  {
    name: "model-modifiers",
    type: "{ trim?: boolean; lazy?: boolean }",
    desc: pick("模型修饰符", "Model modifiers."),
  },
  {
    name: "size",
    type: "small | default | large | sm | md | lg",
    desc: pick("字段尺寸", "Field size."),
  },
  {
    name: "rows",
    type: "number",
    default: "3",
    desc: pick("默认可见行数", "Default visible row count."),
  },
  ...
  { name: "minlength", type: "number", desc: pick("最小字符数", "Minimum character count.") },
  {
    name: "show-count",
    type: "boolean",
    desc: pick("配合 maxlength 显示当前值/上限", "Shows current/maximum count with maxlength."),
  },
  {
    name: "show-word-limit",
    type: "boolean",
    desc: pick(
      "show-count 的 Element Plus 兼容名称",
      "Element Plus-compatible alias for show-count.",
    ),
  },
  {
  ...
  },
  {
    ...
    desc: pick("自动调整高度", "Automatically adjusts height."),
  },
  {
    name: "resize",
  ...
  { name: "aria-label / label", type: "string", desc: pick("无障碍标签", "Accessible label.") },
  {
    name: "tabindex",
    type: "string | number",
    desc: pick("键盘导航顺序", "Keyboard navigation order."),
  },
  {
    name: "validate-event",
    type: "boolean",
    default: "true",
    desc: pick("输入时是否触发表单校验", "Whether input triggers form validation."),
  },
  {
    name: "input-style",
    type: "string | object",
  ...
  },
  {
    ...
    desc: pick("自定义字素计数函数", "Custom grapheme-count function."),
  },
];
...
const eventsRows = [
  { name: "input", type: "(v: string) => void", desc: pick("输入时触发", "Emitted on input.") },
  {
    name: "change",
    type: "(v: string) => void",
    desc: pick("提交变更时触发", "Emitted when a change is committed."),
  },
...
const exposesRows = [
  ...
  },
  {
    name: "resizeTextarea",
    type: "() => void",
    desc: pick("重新计算自动高度", "Recalculates autosize height."),
  },
  {
    name: "textareaStyle",
    type: "() => CSSStyleDeclaration | null",
    desc: pick("读取文本域计算样式", "Returns the textarea's computed style."),
  },
  {
    name: "isComposing",
    type: "Ref<boolean>",
    desc: pick("当前输入法组合状态", "Current IME composition state."),
  },
];

...
const t = createDocsTranslator({
  formatting: { zh: "格式化与插槽", en: "Formatting and slots" },
  amountHint: { zh: "请输入金额", en: "Enter an amount" },
  total: { zh: "总价", en: "Total" },
  raw: { zh: "原始值", en: "Raw value" },
  count: { zh: "字数统计", en: "Character count" },
  nicknameHint: { zh: "昵称最多 12 个字符", en: "Nickname up to 12 characters" },
  nickname: { zh: "昵称", en: "Nickname" },
  native: { zh: "原生属性", en: "Native attributes" },
  phone: { zh: "手机号", en: "Phone number" },
  focusTitle: { zh: "命令式焦点", en: "Imperative focus" },
  focusHint: { zh: "使用标题按钮控制焦点", en: "Control focus with the action buttons" },

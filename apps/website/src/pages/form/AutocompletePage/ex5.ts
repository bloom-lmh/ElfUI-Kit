...
const t = createDocsTranslator({
  ...
  errorHint: {
    zh: "输入 error，再修改关键词即可恢复",
    en: "Type error, then change the query to recover",
  },
  comment: {
    zh: "输入 error 查看错误态，输入 unknown 查看空态",
    en: "Type error for the error state or unknown for the empty state.",
  },

...
const propsRows = () => [
  ...
  {
    name: "readonly / editable / disabled / clearable",
    type: "boolean",
  ...
  },
  {
    ...
    type: "FieldVariant / string / string",
    default: "filled / Form / ''",
    desc: pick(
      "共享字段表面、继承尺寸与浮动标签。",
  ...
  },
  {
    ...
    type: "boolean / TimePickerPlacement / TimePickerPlacement[]",
  ...
  },
  {
    ...
    type: "TimePickerPopperOptions / string / CSSProperties",
    default: "{} / '' / {}",
    desc: pick(
      "浮层定位策略与外观扩展。",
  ...
  {
    name: "prefixIcon / clearIcon / arrowControl",
...
const methodsRows = () => [
  {
    name: "focusInput(target?) / blurInput()",
    type: "Function",
    default: "-",
    desc: pick("控制开始或结束触发器焦点。", "Control focus for the start or end trigger."),
  },
  {
    name: "handleOpen(target?) / handleClose()",
    type: "Function",
    default: "-",
...
const PageTimePickerProps = defineHtml(`
  <h2>API</h2>
  <elf-props-table title="elf-time-picker Props" :rows=${propsRows()}></elf-props-table>
  <elf-props-table title="elf-time-picker Events" :rows=${eventsRows()}></elf-props-table>
  <elf-props-table title="elf-time-picker Methods" :rows=${methodsRows()}></elf-props-table>
`);

...
const propsRows = () => [
  ...
  {
    name: "type / range / multiple",
    type: "DatePickerType / boolean / boolean",
    default: "date / false / false",
    desc: pick(
  ...
  },
  {
    ...
    type: "FieldVariant / DatePickerSize / string",
    default: "filled / Form / ''",
    desc: pick(
  ...
  {
    name: "min / max / disabledDate",
    type: "string / string / (date: Date) => boolean",
    default: "'' / '' / -",
    desc: pick(
      "限制可选边界，并通过纯函数禁用具体日期。",
  ...
  {
    name: "actions / showHeader / header",
  ...
  {
    name: "placeholder / startPlaceholder / endPlaceholder / rangeSeparator",
    type: "string",
  ...
  {
    name: "cellClassName / showWeekNumber",
    type: "(date: Date) => string / boolean",
    default: "- / false",
    desc: pick(
  ...
  {
    name: "emptyValues / valueOnClear",
    type: "unknown[] / DatePickerValue | Function",
  ...
  {
    name: "confirmText / cancelText / clearText",
    type: "string",
    default: "LocaleProvider",
  ...
  },
  {
    ...
    type: "boolean / DatePickerPlacement / DatePickerPlacement[]",
    default: "true / bottom-start / ['top-start']",
    desc: pick(
  ...
  {
    name: "popperOptions / popperClass / popperStyle",
    type: "DatePickerPopperOptions / string / CSSProperties",
    default: "{} / '' / {}",
    desc: pick(
      "复用锚定浮层定位策略并扩展面板外观。",
...
const eventRows = () => [
  {
    name: "update:modelValue / update:endValue",
    type: "(value) => void",
    desc: pick(
      "提交受控单值、多选值或范围结束值。",
...
const PageDatePickerProps = defineHtml(`
  <h2>API</h2>
  <elf-props-table title="elf-date-picker Props" :rows=${propsRows()}></elf-props-table>
  <elf-props-table title="elf-date-picker Events" :rows=${eventRows()}></elf-props-table>
  <elf-props-table title="elf-date-picker Methods" :rows=${methodRows()}></elf-props-table>
  <elf-props-table title="elf-date-picker Slots" :rows=${slotRows()}></elf-props-table>
`);

...
const propsRows = [
  {
    ...
    default: "info",
    desc: pick("类型", "Alert type."),
  },
  {
    name: "variant",
    type: "tonal | soft | elevated | outlined | filled | plain",
    default: "tonal",
    desc: pick("变体风格", "Visual variant."),
  },
  ...
  },
  {
    ...
    type: "string",
    default: "",
    desc: pick("关闭按钮文字（替代 × 图标）", "Close-button text that replaces the × icon."),
  },
  {
    name: "show-icon",
    type: "boolean",
    default: "true",
    desc: pick("显示图标", "Show the status icon."),
  },
  {
    name: "center",
    type: "boolean",
    default: "false",
    desc: pick("内容居中", "Center the content."),
  },
  {
    name: "density",
    type: "default | compact",
    default: "default",
    desc: pick("紧凑模式", "Content density."),
  },
  {
    name: "prominent",
    type: "boolean",
...
const eventsRows = [
  {
    name: "close",
    type: "() => void",
    desc: pick("点击关闭按钮触发", "Emitted when the close button is clicked."),
  },
];
...
const slotsRows = [
  {
    name: "default",
    desc: pick(
      "描述内容（替换 description 属性）",
      "Description content that replaces the description prop.",
    ),
  },
...
const PageAlertProps = defineHtml(`
    <elf-api-builder component="elf-alert" title="API">

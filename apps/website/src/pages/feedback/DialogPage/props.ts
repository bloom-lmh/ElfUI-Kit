...
const propsRows = [
  ...
  { name: "title", type: "string", default: "''", desc: pick("对话框标题。", "Dialog title.") },
  {
    ...
    default: "md",
    desc: pick("预设面板尺寸。", "Preset panel size."),
  },
  {
    name: "close-on-mask",
    type: "boolean",
  ...
  },
  {
    ...
    default: "true",
    desc: pick(
      "按 Escape 时请求关闭最上层对话框。",
      "Request closing the topmost dialog on Escape.",
    ),
  },
  {
    name: "closable",
...
const eventsRows = [
  ...
  },
  {
    ...
    type: "() => void",
    desc: pick("初始焦点进入对话框后触发。", "Emitted after initial focus enters the dialog."),
  },
  {

...
import { ElfNotification } from "@elfui/kit";
...
const t = createDocsTranslator({
  ...
  infoMessage: {
    zh: "有新的更新可用，请查收系统公告。",
    en: "A new update is available. Please review the system announcement.",
  },
  successTitle: { zh: "成功", en: "Success" },
  successMessage: {
    zh: "您的账号密码已成功重置，请妥善保管。",
    en: "Your account password was reset successfully.",
  },
  warningTitle: { zh: "安全警告", en: "Security warning" },
  warningMessage: {
    zh: "发现异常登录尝试，登录地点：北京。",
    en: "An unusual sign-in attempt was detected in Beijing.",
  },
  errorTitle: { zh: "同步失败", en: "Sync failed" },
  errorMessage: {
    zh: "无法连接到云数据库，系统将在一分钟后重试。",
    en: "The cloud database is unavailable. The system will retry in one minute.",
  },

...
const t = createDocsTranslator({
  ...
  duration: {
    zh: "滚动时长；默认继承 ConfigProvider",
    en: "Duration inherited from ConfigProvider by default",
  },
  easing: {
    zh: "滚动缓动策略；默认继承 ConfigProvider",
    en: "Easing inherited from ConfigProvider by default",
  },

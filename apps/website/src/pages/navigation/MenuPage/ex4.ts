...
const t = createDocsTranslator({
  sectionFull: {
    zh: "分隔线、徽章、分组与头尾区域",
    en: "Dividers, badges, groups, header, and footer",
  },
  titleFull: {
    zh: "完整菜单：分隔线、徽章、分组、头像、底栏",
    en: "Complete menu with dividers, badges, groups, avatar, and footer",
  },
  sectionSearch: {
    zh: "搜索、分组、徽章与折叠按钮",
    en: "Search, groups, badges, and collapse control",
  },
  titleSearch: {
    zh: "搜索过滤 + 分组标题 + 折叠切换",
    en: "Search filtering + group headings + collapse toggle",
  },
  ...
  liked: { zh: "喜欢", en: "Liked" },
  saved: { zh: "已保存", en: "Saved" },
  administrator: { zh: "管理员", en: "Administrator" },
...
const localizeItems = (source: LocalizedMenuItem[]): LocalizedMenuItem[] =>
  source.map((item) => ({
    ...item,

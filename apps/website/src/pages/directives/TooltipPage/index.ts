...
const t = createDocsTranslator({
  ...
  title: { zh: "工具提示", en: "Tooltip" },
  description: {
    zh: "为原生或自定义元素附加延迟、定位和 aria-describedby 语义。",
    en: "Attach delay, positioning, and aria-describedby semantics to native or custom elements.",
  },
  demo: { zh: "悬停或聚焦", en: "Hover or focus" },
  top: { zh: "顶部", en: "Top" },
  right: { zh: "右侧", en: "Right" },
  api: { zh: "API", en: "API" },
  type: { zh: "类型", en: "Type" },
  desc: { zh: "说明", en: "Description" },
  content: { zh: "显示的纯文本内容。", en: "Plain text content to show." },
  placement: { zh: "top、bottom、left 或 right。", en: "top, bottom, left, or right." },
  showDelay: { zh: "显示前延迟时间。", en: "Delay before display." },
  hideDelay: { zh: "隐藏前延迟时间。", en: "Delay before hiding." },
});

...
const t = createDocsTranslator({
  ...
  detail: {
    zh: "水印层附加到报告容器，不移动组件内容；删除后由受限 MutationObserver 恢复。",
    en: "The watermark attaches to the report container without moving content and is restored by a scoped MutationObserver.",
  },
});

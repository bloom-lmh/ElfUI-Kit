...
const t = createDocsTranslator({
  section: { zh: "List 列表", en: "List" },
  title: { zh: "结构化任务列表", en: "Structured task list" },
  design: { zh: "设计系统评审", en: "Design system review" },
  regression: { zh: "组件回归测试", en: "Component regression testing" },
  release: { zh: "发布候选版本", en: "Release candidate" },
  today1030: { zh: "今天 10:30", en: "Today 10:30" },
  today1400: { zh: "今天 14:00", en: "Today 14:00" },
  tomorrow0900: { zh: "明天 09:00", en: "Tomorrow 09:00" },
});

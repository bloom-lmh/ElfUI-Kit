...
const t = createDocsTranslator({
  ...
  emptyText: {
    zh: "无数据且没有默认插槽时的提示。",
    en: "Fallback shown without data or default content.",
  },
  ...
  defaultSlot: {
    zh: "声明式 ListItem，或 ListItem 的正文。",
    en: "Declarative ListItems or ListItem body content.",
  },
...
const listProps = () => [
  ...
  {
    name: "render-item",
    type: "(item, index) => Node | primitive",
    default: "—",
    desc: t("renderItem"),
  },

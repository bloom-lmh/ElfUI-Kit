...
const t = createDocsTranslator({
  ...
  imageAlt: {
    zh: "封面替代文本；装饰图可留空",
    en: "Cover alternative text; leave empty for decorative media",
  },
  ...
  clickable: {
    zh: "启用整卡按钮语义和键盘激活",
    en: "Enables whole-card button semantics and keyboard activation",
  },
  disabled: {
    zh: "禁用整卡交互并退出 Tab 顺序",
    en: "Disables whole-card interaction and removes it from the Tab order",
  },
  loading: {
    zh: "播报加载状态并暂时锁定整卡交互",
    en: "Announces loading and temporarily locks whole-card interaction",
  },
  click: {
    zh: "整卡被点击、Enter 或 Space 激活时触发",
    en: "Emitted when the whole card activates by click, Enter, or Space",
  },
...
const PageCardProps = defineHtml(`
  <elf-api-builder component="elf-card" title="API">

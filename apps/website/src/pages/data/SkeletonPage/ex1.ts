...
const t = createDocsTranslator({
  ...
  imagePlayground: {
    zh: "image 变体使用矩形与默认高度",
    en: "The image variant uses a rectangle and default height",
  },
  ...
  loadedDetail: {
    zh: "默认插槽只会在加载结束后显示。",
    en: "The default slot appears only after loading finishes.",
  },
...
const code1 = `<elf-skeleton loading rows="2" />
<elf-skeleton loading variant="text" rows="2" style="margin-top:12px" />
<elf-skeleton loading variant="text" count="1" width="60%" style="margin-top:8px" />`;

const code2 = `<elf-skeleton loading variant="circle" width="48px" height="48px" />
<elf-skeleton loading variant="circle" width="36px" height="36px" />
<elf-skeleton loading variant="circle" width="28px" height="28px" />

<elf-skeleton loading variant="rect" width="100%" height="132px" />
<elf-skeleton loading variant="rect" width="60%" height="32px" />
<elf-skeleton loading variant="rect" width="40%" height="18px" />`;

const code3 = `<elf-skeleton loading variant="image" width="100%" height="138px" />
...
const PageSkeletonEx1 = defineHtml(`
  ...
  <elf-playground :title=${t("imagePlayground")} :code="code3">
    <div style="width:min(100%,300px)">
      <elf-skeleton loading variant="image" width="100%" height="138px" />
      <elf-skeleton loading variant="text" count="1" width="60%" height="20px" style="margin-top:16px" />
      <elf-skeleton loading variant="text" count="1" width="40%" height="14px" style="margin-top:6px" />
    </div>
  </elf-playground>
